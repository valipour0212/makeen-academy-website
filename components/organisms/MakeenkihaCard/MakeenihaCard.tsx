...
function MakeenihaCard({image, fullName, jobTitle, companyLogo, course}: MakeenihaCardProps): JSX.Element {
    return (
        <div className="flex bg-white min-w-64 min-h-20 p-4 gap-2 rounded-2xl shadow-md">
